...
(function (global) {
  ...
  var DICT = {
    ...
    en: { tut_extras:'Beyond the tools — automatic generators', tut_extras_d:'These are not on the tool rail; they appear in the right panel when you pick the related tool.', o_measurearea:'Close as area',
      ...
      o_biomegen:'Auto-assign biomes', o_biomegen_go:'🌍 Assign biomes', h_biomegen:'Fills the terrain layer automatically by elevation and latitude; replaces the current terrain layer.', biomegen_empty:'Draw land first.', o_climate:'Climate', o_climate_on:'Use the climate model', o_climate_eq:'Equator position', o_climate_str:'Rain-shadow strength', o_climate_wind:'Show wind arrows', h_climate:'Move the equator away from the middle of the canvas to make single-hemisphere or polar maps. Wind dries the cells behind mountains (rain shadow) and moistens the ones in front — the next "Assign biomes" run takes this into account.',
