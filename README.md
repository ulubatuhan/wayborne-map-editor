...
**Bölge tipleri, notlar, kendi isim kültürün ve kara şablonların:** Dört küçük editör, dört ayrı yerde. **Bölge tipi** — seçili bir bölgeye savaş bölgesi / anomali / yasak bölge / av sahası / karantina / kutsal alan / ticaret bölgesi tipi verirsin; tipli bölge artık siyasi bir birim değildir, devlet/kültür/din görünümlerinin hiçbirine ait olmaz ve her görünümde kendi tarama deseniyle çizilir. **Not** — herhangi bir vektör nesnesine (sembol, etiket, nehir, bölge, harita bağlantısı) serbest metin notu iliştirilir; haritada notun kendisi değil küçük bir sayfa işareti görünür, metin sağ panelde okunur ve `.json` ile GeoJSON çıktısına birlikte gider. **Kendi kültürün** — "Etiket" panelindeki ad üretecine kendi hece havuzlarını (başlangıç / ara ses / bitiş) girerek yeni bir kültür eklersin; bu kültür ad önerilerinde de, kültür/din üretecinde de kullanılabilir ve proje dosyasına yazılır. **Kara şablonu** — o anki pürüzlülük ve nehir/göl/arazi seçimlerini bir adla kaydedip şablon listesine dördüncü (beşinci, altıncı…) seçenek olarak eklersin; yeni bir algoritma değil, adlandırılmış bir parametre kümesidir.
